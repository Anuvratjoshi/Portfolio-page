    ...
    <div className="portfolio-container">
      ...
      <div className="about-section">
        ...
        <div className="about-content">
          <p>As a mechanical engineer with a passion for technology, I have developed a diverse set of skills that would be valuable to your company. My knowledge in various technology allows me to approach problems from a unique perspective and develop innovative solutions that deliver real results.</p>
          ...
          <p><p>With my knowledge and experience, I am confident that I can bring value to your company. I am a quick learner and eager to take on new challenges, and I am committed to continuous learning and self-improvement.</p></p>
        </div>
      </div>
